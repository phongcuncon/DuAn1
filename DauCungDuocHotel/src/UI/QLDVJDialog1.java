 ...
 * @author dieucap
 */
public class QLDVJDialog1 extends javax.swing.JDialog {

    /**
     * Creates new form QLDV
     */
    public QLDVJDialog1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLDVJDialog1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QLDVJDialog1 dialog = new QLDVJDialog1(new javax.swing.JFrame(), true);
